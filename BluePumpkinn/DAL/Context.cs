 ...
 protected override void Seed(BluePumpkinn.Models.ApplicationDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                System.IO.FileStream file5 = new System.IO.FileStream(@"C:\Users\Vlado\Desktop\BluePumpkin\zamestnaci_jednotna_velkost\christine-j-maynard.jpg", System.IO.FileMode.Open, System.IO.FileAccess.Read);
                byte[] data5 = new byte[file5.Length];
                file5.Read(data5, 0, data5.Length);
                file5.Close();

                System.IO.FileStream file6 = new System.IO.FileStream(@"C:\Users\Vlado\Desktop\BluePumpkin\zamestnaci_jednotna_velkost\elisabeth-c-cooper.jpg", System.IO.FileMode.Open, System.IO.FileAccess.Read);
                ...
                file7.Read(data6, 0, data7.Length);
                file7.Close();
